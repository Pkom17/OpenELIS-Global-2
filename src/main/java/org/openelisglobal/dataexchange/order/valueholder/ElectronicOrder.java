...
public class ElectronicOrder extends BaseObject<String> {
	...
	public enum SortOrder {
		...
		RECEPTION_DATE("orderTimestampdesc", "eorder.orderTimestampdesc");
	...
	private Integer referringFacilityId;
	private String statusId;
	private StatusOfSample status; // not persisted
	private Timestamp orderTimestamp; // order received date
	private Timestamp collectionDate; // order received date
	private String data;
	...
	public Integer getReferringFacilityId() {
		return referringFacilityId;
	}

	public void setReferringFacilityId(Integer referringFacilityId) {
