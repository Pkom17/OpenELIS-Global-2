...
public class DeletePatientTestDataController extends BaseController {
	...
	public ModelAndView cleanSamplePatientDatabaseEntries(HttpServletRequest request) {
		...
		if (!"true".equals(ConfigurationProperties.getInstance()
			...
			return findForward(FWD_FAIL_DELETE, null);
		}
		...
		return findForward(FWD_SUCCESS_DELETE, null);
	}
