...
public abstract class BaseDAOImpl<T extends BaseObject<PK>, PK extends Serializable>
	...
	public T update(T object) {
		try {
//            T managedObject = entityManager.find(classType, object.getId());
//            if (managedObject != null) {
//                BeanUtils.copyProperties(managedObject, object);
//            } else {
//            	managedObject = entityManager.merge(object);
//            }
			if (!entityManager.contains(object)) {
				T managedObject = entityManager.find(classType, object.getId());
				if (managedObject != null) {
					BeanUtils.copyProperties(object, managedObject, "id");
					entityManager.flush();
